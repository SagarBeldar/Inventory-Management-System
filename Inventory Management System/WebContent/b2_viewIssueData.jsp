			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="b2_issuesRawM.html">
...
<% 
 ...
 try{
 	PreparedStatement pstmt =con.prepareStatement("select * from issueRaw");
...
<!-- <Td> <a href="b2_issueApproval.jsp?id=<%=rs.getString(1)%>">Approved</a></Td>-->
