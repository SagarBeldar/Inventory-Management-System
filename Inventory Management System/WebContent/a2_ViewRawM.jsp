			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="a2_Raw_M_Data.html">
        ...
        <div class="main">
            ...
            <main class="content">
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">View Material Data Log :</h1>
...
<% 
 ...
 try{
 	PreparedStatement pstmt =con.prepareStatement("select * from rawMaterial WHERE Quantity > 0");
