			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="c2_issueProcessedRaw.html">
        ...
        <div class="main">
            ...
            <main class="content">
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">Issued Processed Material Requested Quotation :</h1>
...
<% 
 ...
 try{
 	PreparedStatement pstmt =con.prepareStatement("select * from issueProcessed");
...
<!-- <Td> <a href="d2_DeleteProcessedissue.jsp?id=<%=rs.getString(1)%>">delete</a></Td>
<Td> <a href="d2_ApprovalprocessedData.jsp?id=<%=rs.getString(1)%>">Approved</a></Td> -->
</TR>
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>nventory Management System
                                        </strong></a> &copy;
                            </p>
                        </div>
