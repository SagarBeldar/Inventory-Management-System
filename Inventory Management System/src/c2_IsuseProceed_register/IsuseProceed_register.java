package c2_IsuseProceed_register;
...
/**
 * Servlet implementation class IsuseProceed_register
 */
@WebServlet("/IsuseProceed_register")
public class IsuseProceed_register extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IsuseProceed_register() {
        super();
		...
		Connection con = Dbconnection.connect();
		   ...
		   System.out.println("heyyy");
		     try {
		         ...
		         PreparedStatement pstmt = con.prepareStatement("insert into issueprocessed values (?,?,?,?,?,?,?,?)");
		         pstmt.setInt(1, Id);
...
//		 	            
		 	            if (rowsInserted > 0) {			            
//				             System.out.println("Insert successful!");
		 	           response.sendRedirect("c2_issueProcessedRaw.html");
		 	            }	             
		          else 
		 	        {
